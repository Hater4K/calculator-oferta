...
- Pentru fiecare produs, din partida foloseste butonul `Alege poza` de sub SKU. Imaginea se salveaza in Firebase, apare imediat in randul produsului si se transfera automat in oferta si PDF.
